...
function saveList() {
    ...
    window.localStorage.setItem("myItemsJSON", JSON.stringify(myItems));
    
    var retrievedData = JSON.parse(window.localStorage.getItem("myItemsJSON"));
...
function deleteAll(){
	...
	if (myItems.length == 0){
        ...
        alert("To resume adding tasks, refresh the page.");
